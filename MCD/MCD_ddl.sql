...
ALTER TABLE NOTES ADD FOREIGN KEY (id_album) REFERENCES ALBUMS (id_album);
ALTER TABLE NOTES ADD FOREIGN KEY (email) REFERENCES UTILISATEURS (email);
